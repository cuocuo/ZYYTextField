...
//  ZYYTextField
//
//  Created by 郑雨阳 on 2017/7/28.
//  Copyright © 2017年 shiheng. All rights reserved.
//

#import "ZYYTextField.h"
@interface ZYYTextField()<CAAnimationDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(zyy_textFieldDidEndEditing:) name:UITextFieldTextDidEndEditingNotification object:self];
    return self;
}
...
- (void)zyy_textFieldDidBeginEditing:(NSNotification *)notification {
    ...
    [_lineView.layer addAnimation:kfAnimation11 forKey:@"kZYYLienViewWidth"];
    ...
    [_placeholderCacheLabel.layer addAnimation:grouoAnimation forKey:@"kZYYOutAnimation"];
    
}

#pragma mark - UITextFieldTextDidEndEditingNotification
- (void)zyy_textFieldDidEndEditing:(NSNotification *)notification {
    ...
    [_lineView.layer addAnimation:kfAnimation11 forKey:@"kZYYLienViewOpactity"];
    ...
    [_grayLineView.layer addAnimation:kfAnimation12 forKey:@"kZYYGrayLienViewOpactity"];
